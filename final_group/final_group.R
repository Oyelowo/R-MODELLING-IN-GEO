...
#         title = "Distribution of Predictors by NDVI")
# 
# 
# 
...
for (i in 1:rep){
  ...
  #using the normal gbm, package.
  #GBM
  cryo_gbm1<-gbm(formula = Cryoturb~ NDVI+ RR_annual + Radiation+ Slope+Tavg_7, data=cal,
